...
<body>
            ...
            <td style="text-align: right;width: 300px; border :none; backgrounsd-color: red">
                <table class="summary-table"
                    ...
                    <tr class="summary-header" style="border: none;background-color:#eeeeee">
                        <th style="text-align: center; border :none; padding:5px">Total Employees</th>
                        <th style="text-align: center; border :none; padding:5px">Total Devices</th>
                        <th style="text-align: center; border :none">Total Departments</th>
                    </tr>
                    <tr style="border: none">
                        <td style="text-align: center; border :none; padding:5px;">75</td>
                        <td style="text-align: center; border :none; padding:5px;">12</td>
                        <td style="text-align: center; border :none; padding:5px;">5</td>
                    </tr>
    ...
    <table class="main-table">
        <tr style="text-align: left;font-weight:bold">
            ...
            <td style="text-align:  center;width:80px"> Log </td>
            <td style="text-align:  center;width:150px"> Device </td>
        </tr>
        @for ($i = 1; $i <= 59; $i++)
            <tbody>
